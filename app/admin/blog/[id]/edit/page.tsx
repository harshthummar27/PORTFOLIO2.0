    ...
    try {
      ...
      if (data.success) {
        ...
        setFormData({
          ...
          author: post.author || 'Harsh Thummar',
          date: postDate,
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <h1 className="text-4xl font-black text-white mb-2">Edit Blog Post</h1>
        <p className="text-white/60">Update blog post information</p>
      </div>
